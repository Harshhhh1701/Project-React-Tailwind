...
const Main = () => {
  return (
    <div name='home' className='w-full h-screen bg-zinc-200 pt-6 flex flex-col justify-between'>
        <div className='grid md:grid-cols-2 max-w-[1240px] m-auto'>
            ...
            <div className=' flex flex-col justify-center py-8 md:min-w-[760px] bottom-[5%]
